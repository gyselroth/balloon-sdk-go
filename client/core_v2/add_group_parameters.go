...
// WithData adds the data to the add group params
func (o *AddGroupParams) WithData(data *models.CoreV2Group) *AddGroupParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the add group params
func (o *AddGroupParams) SetData(data *models.CoreV2Group) {
	o.Data = data
}
