...
func (o *UpdateNodeParams) WithBody(body *models.CoreV2Node) *UpdateNodeParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update node params
func (o *UpdateNodeParams) SetBody(body *models.CoreV2Node) {
	o.Body = body
}

// WithNode adds the node to the update node params
func (o *UpdateNodeParams) WithNode(node string) *UpdateNodeParams {
	o.SetNode(node)
	return o
}

// SetNode adds the node to the update node params
func (o *UpdateNodeParams) SetNode(node string) {
	o.Node = node
}
