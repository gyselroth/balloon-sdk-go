...
// WithData adds the data to the add user params
func (o *AddUserParams) WithData(data *models.CoreV2User) *AddUserParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the add user params
func (o *AddUserParams) SetData(data *models.CoreV2User) {
	o.Data = data
}
