...
// WithAttributes adds the attributes to the get current user params
func (o *GetCurrentUserParams) WithAttributes(attributes []string) *GetCurrentUserParams {
	o.SetAttributes(attributes)
	return o
}

// SetAttributes adds the attributes to the get current user params
func (o *GetCurrentUserParams) SetAttributes(attributes []string) {
