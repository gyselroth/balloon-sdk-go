...
func (o *GetCollectionsParams) WithDeleted(deleted *float64) *GetCollectionsParams {
	o.SetDeleted(deleted)
	return o
}

// SetDeleted adds the deleted to the get collections params
func (o *GetCollectionsParams) SetDeleted(deleted *float64) {
	o.Deleted = deleted
}

// WithLimit adds the limit to the get collections params
func (o *GetCollectionsParams) WithLimit(limit *float64) *GetCollectionsParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the get collections params
func (o *GetCollectionsParams) SetLimit(limit *float64) {
	o.Limit = limit
}

// WithOffset adds the offset to the get collections params
func (o *GetCollectionsParams) WithOffset(offset *float64) *GetCollectionsParams {
	o.SetOffset(offset)
	return o
}

// SetOffset adds the offset to the get collections params
func (o *GetCollectionsParams) SetOffset(offset *float64) {
	o.Offset = offset
}
