...
func (o *GetEventLogParams) WithLimit(limit *float64) *GetEventLogParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the get event log params
func (o *GetEventLogParams) SetLimit(limit *float64) {
	o.Limit = limit
}

// WithOffset adds the offset to the get event log params
func (o *GetEventLogParams) WithOffset(offset *float64) *GetEventLogParams {
	o.SetOffset(offset)
	return o
}

// SetOffset adds the offset to the get event log params
func (o *GetEventLogParams) SetOffset(offset *float64) {
	o.Offset = offset
}
